...
```bash
dotnet nuget push ./artifacts/GOZA.Dock.1.0.6.nupkg --api-key YOUR_API_KEY --source https://api.nuget.org/v3/index.json
```
...
```bash
$env:NUGET_API_KEY = "..."
dotnet nuget push ./artifacts/GOZA.Dock.1.0.6.nupkg --api-key $env:NUGET_API_KEY --source https://api.nuget.org/v3/index.json
```
