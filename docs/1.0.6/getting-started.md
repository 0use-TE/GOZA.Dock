...
> **NuGet package [1.0.6](https://www.nuget.org/packages/GOZA.Dock/1.0.6)** — this site section documents **1.0.6**. Use the **Version** dropdown for older releases. API Reference (navbar) is built from the latest source.
