...
> **NuGet [1.0.1](https://www.nuget.org/packages/GOZA.Dock/1.0.1)** — 本节为 **1.0.1** 文档。较新 [1.0.2](../../1.0.2/zh-CN/getting-started.md) 增加可关闭 Tab、侧栏竖排标题、新建文档按钮。较旧 [1.0.0](../../1.0.0/zh-CN/getting-started.md)。
