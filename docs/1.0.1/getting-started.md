...
> **NuGet package [1.0.1](https://www.nuget.org/packages/GOZA.Dock/1.0.1)** — this section documents **1.0.1**. Newer [1.0.2](../1.0.2/getting-started.md) adds closable tabs, vertical side headers, and Add Doc. Older [1.0.0](../1.0.0/getting-started.md).
