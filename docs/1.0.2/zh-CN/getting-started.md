...
> **NuGet [1.0.2](https://www.nuget.org/packages/GOZA.Dock/1.0.2)** — 本节为 **1.0.2** 文档。顶栏 **Version** 可切换 [1.0.1](../../1.0.1/zh-CN/getting-started.md)、[1.0.0](../../1.0.0/zh-CN/getting-started.md)。API 参考（顶栏）来自最新源码构建。
