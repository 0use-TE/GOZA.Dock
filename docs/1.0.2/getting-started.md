...
> **NuGet package [1.0.2](https://www.nuget.org/packages/GOZA.Dock/1.0.2)** — this site section documents **1.0.2**. Use the **Version** dropdown for [1.0.1](../1.0.1/getting-started.md) or [1.0.0](../1.0.0/getting-started.md). API Reference (navbar) is built from the latest source.
