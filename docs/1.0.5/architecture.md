...
| Type | Key members |
|------|-------------|
| `DockShell` | `EnableParkingLot` (default `true`), `UseVerticalTabHeaders` (default `true`), `DefaultTabStripPlacement` (default `Top`), `IsLayoutExpanded`, `Content`, `ToggleLayoutExpansion` |
