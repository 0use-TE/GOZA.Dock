...
GOZA.Dock 2.0 keeps every layout decision in your hands. The library provides lookless, themed controls and a small set of coordinators; it does **not** decide topology, manage layout trees, or do reflection-based view resolution.
...
└─────────────────────────────────────────────────────────────────────┘
   ...
   (background,      (selection, drag,       (auto-direction,
    parking lot)      surface caching)        themed, hover)
```
