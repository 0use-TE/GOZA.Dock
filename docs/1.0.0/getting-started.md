...
> **NuGet package [1.0.0](https://www.nuget.org/packages/GOZA.Dock/1.0.0)** — initial release documentation. See [1.0.1](../1.0.1/getting-started.md) (parking lot fixes) or [1.0.2](../1.0.2/getting-started.md) (latest).
