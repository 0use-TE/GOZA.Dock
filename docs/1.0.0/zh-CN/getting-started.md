...
> **NuGet [1.0.0](https://www.nuget.org/packages/GOZA.Dock/1.0.0)** — 首次发布文档。见 [1.0.1](../../1.0.1/zh-CN/getting-started.md)（Parking Lot 修复）或 [1.0.2](../../1.0.2/zh-CN/getting-started.md)（最新）。
