...
- Vertical tab headers now use symmetric action lanes so the rotated title stays centered instead of being displaced by Close. Vertical drag ghosts also clone the live tab orientation and footprint.
