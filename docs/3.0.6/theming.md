...
Vertical classic tabs keep the 32px strip metric, center the rotated title between symmetric action lanes, and pin Add → placement → maximize controls to the bottom edge. Their drag ghost uses the same orientation and live tab footprint:
