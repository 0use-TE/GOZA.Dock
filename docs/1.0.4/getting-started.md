...
> **NuGet package [1.0.4](https://www.nuget.org/packages/GOZA.Dock/1.0.4)** — this site section documents **1.0.4**. Use the **Version** dropdown for older releases. API Reference (navbar) is built from the latest source.
