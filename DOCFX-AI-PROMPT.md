...
1. `Copy-Item -Recurse docs/1.0.5 docs/1.0.6`
2. 更新 `docs/1.0.6/` 内版本号、release-notes、getting-started 横幅
3. `goza-versions.json` 增加 `{ "id": "1.0.6", "label": "1.0.6 (latest)" }`，旧 latest 去掉 `(latest)`
4. `toc.yml` topicHref → `docs/1.0.6/getting-started.md`
5. `index.md` 首页表格增加 1.0.6
6. `docfx docfx.json` 验证

---

*GOZA.Dock · package-version docs · 2026-07*
